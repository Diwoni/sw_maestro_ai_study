...
export function AnalyzeForm({
  ...
  return (
    <section className="surface-panel overflow-hidden">
      <div className="flex flex-col gap-6 p-5 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div className="max-w-xl">
            <p className="editorial-kicker">Input / Message</p>
        ...
        <label className="group block">
          ...
          <textarea
            className="min-h-56 w-full resize-y border-2 border-[#d9deef] bg-[#f8f9ff] p-5 text-[15px] font-medium leading-7 text-ink outline-none transition-all duration-300 ease-out placeholder:text-[#9298a9] hover:border-action/50 hover:bg-white focus:border-action focus:bg-white focus:shadow-input sm:min-h-64 sm:p-6"
            value={value.text}
      ...
      <div className="grid border-t border-line bg-[#fbfcff] md:grid-cols-3">
      ...
      <div className="flex flex-col gap-4 border-t border-[#d9deef] bg-action-soft px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-7">
        <div>
        ...
        <button
          type="button"
          className="group inline-flex min-h-12 items-center justify-center gap-3 rounded-md bg-action px-7 py-3 text-sm font-semibold text-white shadow-button transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-action-hover hover:shadow-[0_16px_34px_rgba(49,87,213,0.34)] active:translate-y-0 active:scale-[0.98] disabled:cursor-not-allowed disabled:bg-[#9ba8d5] disabled:shadow-none disabled:hover:translate-y-0 sm:min-w-44"
          disabled={isLoading}
          onClick={onSubmit}
        >
...
function Field({
  ...
  return (
    <label className="grid gap-3 border-b border-line px-5 py-4 last:border-b-0 sm:px-7 md:border-b-0 md:border-r md:last:border-r-0">
...
function Select({
  ...
  return (
    <span className="field-control relative block rounded-md">
      <select
